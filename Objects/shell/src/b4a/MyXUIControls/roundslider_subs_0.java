...
try {
		Debug.PushSubsStack("Base_Resize (roundslider) ","roundslider",21,__ref.getField(false, "ba"),__ref,67);
...
__ref.runClassMethod (b4a.MyXUIControls.roundslider.class, "_createthumb" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.roundslider.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("CreateThumb (roundslider) ","roundslider",21,__ref.getField(false, "ba"),__ref,48);
...
try {
		Debug.PushSubsStack("DesignerCreateView (roundslider) ","roundslider",21,__ref.getField(false, "ba"),__ref,29);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.roundslider.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("Draw (roundslider) ","roundslider",21,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",21,__ref.getField(false, "ba"),__ref,135);
...
try {
		Debug.PushSubsStack("Initialize (roundslider) ","roundslider",21,__ref.getField(false, "ba"),__ref,23);
...
try {
		Debug.PushSubsStack("pnl_Touch (roundslider) ","roundslider",21,__ref.getField(false, "ba"),__ref,97);
...
try {
		Debug.PushSubsStack("setValue (roundslider) ","roundslider",21,__ref.getField(false, "ba"),__ref,130);
