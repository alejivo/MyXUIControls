...
try {
		Debug.PushSubsStack("CmbBox_ItemClick (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,125);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xcombobox.class, "_raiseevent" /*void*/ );
...
try {
		Debug.PushSubsStack("GetItem (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,97);
...
try {
		Debug.PushSubsStack("getSelectedIndex (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,75);
...
try {
		Debug.PushSubsStack("RaiseEvent (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,107);
...
public ResumableSub_RaiseEvent(b4a.MyXUIControls.b4xcombobox parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
Debug.JustUpdateDeviceLine();
_index = __ref.runClassMethod (b4a.MyXUIControls.b4xcombobox.class, "_getselectedindex" /*RemoteObject*/ );Debug.locals.put("index", _index);Debug.locals.put("index", _index);
...
__ref.runClassMethod (b4a.MyXUIControls.b4xcombobox.class, "_setselectedindex" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));};
...
try {
		Debug.PushSubsStack("setSelectedIndex (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,83);
