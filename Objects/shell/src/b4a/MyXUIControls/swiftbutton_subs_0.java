...
try {
		Debug.PushSubsStack("Base_Resize (swiftbutton) ","swiftbutton",23,__ref.getField(false, "ba"),__ref,39);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.swiftbutton.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("DesignerCreateView (swiftbutton) ","swiftbutton",23,__ref.getField(false, "ba"),__ref,23);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.swiftbutton.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("Draw (swiftbutton) ","swiftbutton",23,__ref.getField(false, "ba"),__ref,90);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setTop",_gap);
...
try {
		Debug.PushSubsStack("getEnabled (swiftbutton) ","swiftbutton",23,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("Initialize (swiftbutton) ","swiftbutton",23,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("p_Touch (swiftbutton) ","swiftbutton",23,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("SetColors (swiftbutton) ","swiftbutton",23,__ref.getField(false, "ba"),__ref,84);
...
try {
		Debug.PushSubsStack("setEnabled (swiftbutton) ","swiftbutton",23,__ref.getField(false, "ba"),__ref,51);
