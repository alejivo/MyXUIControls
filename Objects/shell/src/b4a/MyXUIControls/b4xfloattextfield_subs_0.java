...
try {
		Debug.PushSubsStack("Base_Resize (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,174);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_updatelabel" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"getText")),(Object)(b4xfloattextfield.__c.getField(true,"True")));
...
b4xfloattextfield._mnexttextfield = RemoteObject.createNew ("b4a.MyXUIControls.b4xfloattextfield");__ref.setField("_mnexttextfield",b4xfloattextfield._mnexttextfield);
...
try {
		Debug.PushSubsStack("CreateAcceptButton (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,118);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_lblv" /*RemoteObject*/ ,__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createbutton" /*RemoteObject*/ ,(Object)(BA.ObjectToString(b4xfloattextfield.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xe5ca)))))));
...
try {
		Debug.PushSubsStack("CreateBitmap (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,230);
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getWidth"),b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))}, "+",1, 0))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getHeight"),b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))}, "+",1, 0))));
...
try {
		Debug.PushSubsStack("CreateButton (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,160);
...
try {
		Debug.PushSubsStack("CreateClearButton (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,110);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_lblclear" /*RemoteObject*/ ,__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createbutton" /*RemoteObject*/ ,(Object)(BA.ObjectToString(b4xfloattextfield.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xe14c)))))));
...
try {
		Debug.PushSubsStack("CreateRevealButton (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,125);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_lblclear" /*RemoteObject*/ ,__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createbutton" /*RemoteObject*/ ,(Object)(BA.ObjectToString(b4xfloattextfield.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xe8f4)))))));
...
try {
		Debug.PushSubsStack("CreateTextField (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,301);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",_password) && RemoteObject.solveBoolean("!",__ref.getField(true,"_keyboardtype" /*RemoteObject*/ ),BA.ObjectToString("Text"))) { 
...
try {
		Debug.PushSubsStack("CreateTextFieldAll (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,102);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_mtextfield" /*RemoteObject*/ ,__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createtextfield" /*RemoteObject*/ ,(Object)(_passwordmode)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_setnextfield" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mnexttextfield" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,61);
...
Debug.JustUpdateDeviceLine();
b4xfloattextfield.__c.runVoidMethod ("LogImpl","98060951",RemoteObject.createImmutable("Multiline not supported with password mode."),0);
 };
 BA.debugLineNum = 86;BA.debugLine="CreateTextFieldAll(PasswordMode, PassedLabel.Font";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createtextfieldall" /*RemoteObject*/ ,(Object)(_passwordmode),(Object)(_passedlabel.runMethod(false,"getFont")),(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)((_lbl.runMethod(true,"getTextColor"))))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_update" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createrevealbutton" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 96;BA.debugLine="CreateClearButton";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createclearbutton" /*RemoteObject*/ );
 };
 BA.debugLineNum = 98;BA.debugLine="CreateAcceptButton";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createacceptbutton" /*RemoteObject*/ );
 BA.debugLineNum = 99;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("getNextField (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,268);
...
try {
		Debug.PushSubsStack("getText (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,355);
...
try {
		Debug.PushSubsStack("getTextField (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,406);
...
try {
		Debug.PushSubsStack("ime_HandleAction (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,287);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_tf_enterpressed" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Initialize (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,44);
...
try {
		Debug.PushSubsStack("lc_Click (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,370);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_settext" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));
 break; }
case 1: {
 BA.debugLineNum = 376;BA.debugLine="SwitchFromPasswordToRegular (True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_switchfrompasswordtoregular" /*RemoteObject*/ ,(Object)(b4xfloattextfield.__c.getField(true,"True")));
 break; }
case 2: {
 BA.debugLineNum = 378;BA.debugLine="SwitchFromPasswordToRegular(False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_switchfrompasswordtoregular" /*RemoteObject*/ ,(Object)(b4xfloattextfield.__c.getField(true,"False")));
 break; }
case 3: {
...
try {
		Debug.PushSubsStack("RequestFocusAndShowKeyboard (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,411);
...
try {
		Debug.PushSubsStack("setNextField (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,272);
...
_et.setObject(__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).getObject());Debug.locals.put("et", _et);
...
try {
		Debug.PushSubsStack("setText (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,359);
...
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_tf_textchanged" /*RemoteObject*/ ,(Object)(_old),(Object)(_s));};
...
try {
		Debug.PushSubsStack("SwitchFromPasswordToRegular (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,130);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createtextfieldall" /*RemoteObject*/ ,(Object)(b4xfloattextfield.__c.runMethod(true,"Not",(Object)(_toregular))),(Object)(_font1),(Object)(_textcolor));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(b4xfloattextfield.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xe8f4)))));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(b4xfloattextfield.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 0xe8f5)))));
 };
...
try {
		Debug.PushSubsStack("tf_Action (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,250);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mnexttextfield" /*RemoteObject*/ ).runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).runVoidMethod ("RequestFocus");
 };
...
try {
		Debug.PushSubsStack("tf_BeginEdit (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,242);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_tf_focuschanged" /*RemoteObject*/ ,(Object)(b4xfloattextfield.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("tf_EndEdit (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,246);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_tf_focuschanged" /*RemoteObject*/ ,(Object)(b4xfloattextfield.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("tf_EnterPressed (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,293);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_tf_action" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("tf_FocusChanged (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,212);
...
try {
		Debug.PushSubsStack("tf_TextChanged (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,260);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_updatelabel" /*RemoteObject*/ ,(Object)(_new),(Object)(b4xfloattextfield.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("Update (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,218);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_largefocused" /*RemoteObject*/ ,__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createbitmap" /*RemoteObject*/ ,(Object)(_r),(Object)(__ref.getField(true,"_hintcolor" /*RemoteObject*/ )),(Object)(_f)));
 BA.debugLineNum = 222;BA.debugLine="LargeNotFocused = CreateBitmap(r, NonFocusedHintC";
Debug.JustUpdateDeviceLine();
__ref.setField ("_largenotfocused" /*RemoteObject*/ ,__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createbitmap" /*RemoteObject*/ ,(Object)(_r),(Object)(__ref.getField(true,"_nonfocusedhintcolor" /*RemoteObject*/ )),(Object)(_f)));
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_smallfocused" /*RemoteObject*/ ,__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createbitmap" /*RemoteObject*/ ,(Object)(_r),(Object)(__ref.getField(true,"_hintcolor" /*RemoteObject*/ )),(Object)(_f)));
 BA.debugLineNum = 226;BA.debugLine="SmallNotFocused = CreateBitmap(r, NonFocusedHintC";
Debug.JustUpdateDeviceLine();
__ref.setField ("_smallnotfocused" /*RemoteObject*/ ,__ref.runClassMethod (b4a.MyXUIControls.b4xfloattextfield.class, "_createbitmap" /*RemoteObject*/ ,(Object)(_r),(Object)(__ref.getField(true,"_nonfocusedhintcolor" /*RemoteObject*/ )),(Object)(_f)));
...
try {
		Debug.PushSubsStack("UpdateLabel (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,188);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_hintimageview" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated",(Object)(__ref.getField(true,"_duration" /*RemoteObject*/ )),(Object)(b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(BA.numberCast(int.class, _b.runMethod(true,"getWidth"))),(Object)(BA.numberCast(int.class, _b.runMethod(true,"getHeight"))));
