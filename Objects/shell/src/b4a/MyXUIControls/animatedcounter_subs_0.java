...
try {
		Debug.PushSubsStack("Base_Resize (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,67);
...
_bmp = __ref.runClassMethod (b4a.MyXUIControls.animatedcounter.class, "_createbitmap" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lbltemplate" /*RemoteObject*/ )));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
...
try {
		Debug.PushSubsStack("CreateBitmap (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,90);
...
try {
		Debug.PushSubsStack("CreateFadeBitmap (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("DesignerCreateView (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,28);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_fade" /*RemoteObject*/ ,__ref.runClassMethod (b4a.MyXUIControls.animatedcounter.class, "_createfadebitmap" /*RemoteObject*/ ));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.animatedcounter.class, "_setvalue" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.animatedcounter.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
 BA.debugLineNum = 50;BA.debugLine="setValue(getValue)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.animatedcounter.class, "_setvalue" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4a.MyXUIControls.animatedcounter.class, "_getvalue" /*RemoteObject*/ )));
 };
...
try {
		Debug.PushSubsStack("getValue (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("Initialize (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("setValue (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,106);
...
try {
		Debug.PushSubsStack("TopFromValue (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,85);
