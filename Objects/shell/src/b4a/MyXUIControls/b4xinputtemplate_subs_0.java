...
b4xinputtemplate._xdialog = RemoteObject.createNew ("b4a.MyXUIControls.b4xdialog");__ref.setField("_xdialog",b4xinputtemplate._xdialog);
...
b4xinputtemplate._lbltitle = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_lbltitle",b4xinputtemplate._lbltitle);
...
try {
		Debug.PushSubsStack("ConfigureForNumbers (b4xinputtemplate) ","b4xinputtemplate",11,__ref.getField(false, "ba"),__ref,30);
...
_et.setObject(__ref.getField(false,"_textfield1" /*RemoteObject*/ ).getObject());Debug.locals.put("et", _et);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xinputtemplate) ","b4xinputtemplate",11,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("GetPanel (b4xinputtemplate) ","b4xinputtemplate",11,__ref.getField(false, "ba"),__ref,90);
...
try {
		Debug.PushSubsStack("Initialize (b4xinputtemplate) ","b4xinputtemplate",11,__ref.getField(false, "ba"),__ref,14);
...
_jo.setObject(__ref.getField(false,"_textfield1" /*RemoteObject*/ ).getObject());Debug.locals.put("jo", _jo);
...
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setImeOptions")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(b4xinputtemplate.__c.getField(false,"Bit").runMethod(true,"Or",(Object)(BA.numberCast(int.class, 33554432)),(Object)(BA.numberCast(int.class, 6))))})));
 BA.debugLineNum = 24;BA.debugLine="Dim jo As JavaObject = Me";
Debug.JustUpdateDeviceLine();
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo.setObject(__ref);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 25;BA.debugLine="jo.RunMethod(\"RemoveWarning\", Null)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("IsValid (b4xinputtemplate) ","b4xinputtemplate",11,__ref.getField(false, "ba"),__ref,77);
...
try {
		Debug.PushSubsStack("Show (b4xinputtemplate) ","b4xinputtemplate",11,__ref.getField(false, "ba"),__ref,94);
...
public ResumableSub_Show(b4a.MyXUIControls.b4xinputtemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xinputtemplate.class, "_validate" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_text" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("TextField1_Action (b4xinputtemplate) ","b4xinputtemplate",11,__ref.getField(false, "ba"),__ref,81);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xinputtemplate.class, "_textfield1_enterpressed" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("TextField1_EnterPressed (b4xinputtemplate) ","b4xinputtemplate",11,__ref.getField(false, "ba"),__ref,85);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4a.MyXUIControls.b4xinputtemplate.class, "_isvalid" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_textfield1" /*RemoteObject*/ ).runMethod(true,"getText"))).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("TextField1_TextChanged (b4xinputtemplate) ","b4xinputtemplate",11,__ref.getField(false, "ba"),__ref,60);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xinputtemplate.class, "_validate" /*RemoteObject*/ ,(Object)(_new));
...
try {
		Debug.PushSubsStack("Validate (b4xinputtemplate) ","b4xinputtemplate",11,__ref.getField(false, "ba"),__ref,64);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4a.MyXUIControls.b4xinputtemplate.class, "_isvalid" /*RemoteObject*/ ,(Object)(_new)),b4xinputtemplate.__c.getField(true,"False"))) { 
