...
try {
		Debug.PushSubsStack("Base_Resize (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,48);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.anotherprogressbar.class, "_updategraphics" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("BusyLoop (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,58);
...
public ResumableSub_BusyLoop(b4a.MyXUIControls.anotherprogressbar parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.anotherprogressbar.class, "_setvalue" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Value"))),(Object)(RemoteObject.createImmutable((100)))))));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.anotherprogressbar.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("getValue (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,147);
...
try {
		Debug.PushSubsStack("getVisible (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,143);
...
try {
		Debug.PushSubsStack("setValue (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,151);
...
try {
		Debug.PushSubsStack("SetValueNoAnimation (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,155);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.anotherprogressbar.class, "_setvalue" /*RemoteObject*/ ,(Object)(_v));
...
try {
		Debug.PushSubsStack("setVisible (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,135);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.anotherprogressbar.class, "_busyloop" /*void*/ );
 };
...
try {
		Debug.PushSubsStack("UpdateGraphics (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,102);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.anotherprogressbar.class, "_setvisible" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getVisible")));
