...
try {
		Debug.PushSubsStack("Background_Click (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,249);
...
try {
		Debug.PushSubsStack("Background_Touch (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,244);
...
try {
		Debug.PushSubsStack("Blur (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,278);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_setavg" /*RemoteObject*/ ,(Object)(_bc),(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, _y)),(Object)(_clrs),(Object)(_temp));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_setavg" /*RemoteObject*/ ,(Object)(_bc),(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y)),(Object)(_clrs),(Object)(_temp));
 }
}Debug.locals.put("x", _x);
;
 }
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_setavg" /*RemoteObject*/ ,(Object)(_bc),(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, 1)),(Object)(_clrs),(Object)(_temp));
...
Debug.JustUpdateDeviceLine();
b4xdialog.__c.runVoidMethod ("LogImpl","97602212",RemoteObject.concat(RemoteObject.createImmutable("Time: "),(RemoteObject.solve(new RemoteObject[] {b4xdialog.__c.getField(false,"DateTime").runMethod(true,"getNow"),_n}, "-",1, 2))),0);
...
try {
		Debug.PushSubsStack("Button_Click (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,225);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))));
...
try {
		Debug.PushSubsStack("Close (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,230);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_getvisible" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("CreateButton (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,186);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_internalsettextorcsbuildertolabel" /*RemoteObject*/ ,(Object)(_xbtn),(Object)(_text));
...
try {
		Debug.PushSubsStack("GetButton (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,208);
...
try {
		Debug.PushSubsStack("getVisible (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("Initialize (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("InternalAddStubToCLVIfNeeded (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,332);
...
Debug.JustUpdateDeviceLine();
_height = RemoteObject.solve(new RemoteObject[] {_customlistview1.runMethod(false,"_asview").runMethod(true,"getHeight"),_lastitem.getField(true,"Offset"),_lastitem.getField(false,"Panel").runMethod(true,"getHeight"),b4xdialog.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))}, "---",3, 1);Debug.locals.put("Height", _height);Debug.locals.put("Height", _height);
...
try {
		Debug.PushSubsStack("InternalSetTextOrCSBuilderToLabel (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,347);
...
try {
		Debug.PushSubsStack("Resize (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,254);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_updateblur" /*RemoteObject*/ );
 };
...
try {
		Debug.PushSubsStack("SetAvg (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,318);
...
try {
		Debug.PushSubsStack("SetButtonState (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,216);
...
Debug.JustUpdateDeviceLine();
_b = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_b = __ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_getbutton" /*RemoteObject*/ ,(Object)(_resultcode));Debug.locals.put("b", _b);Debug.locals.put("b", _b);
...
try {
		Debug.PushSubsStack("Show (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,68);
...
public ResumableSub_Show(b4a.MyXUIControls.b4xdialog parent,RemoteObject __ref,RemoteObject _text,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
this._text = _text;
this._yes = _yes;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_internalsettextorcsbuildertolabel" /*RemoteObject*/ ,(Object)(_xlbl),(Object)(_text));
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xdialog", "show"), __ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_showcustom" /*RemoteObject*/ ,(Object)(_p),(Object)(_yes),(Object)(_no),(Object)(_cancel)));
this.state = 1;
return;
case 1:
//C
...
try {
		Debug.PushSubsStack("ShowCustom (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,91);
...
public ResumableSub_ShowCustom(b4a.MyXUIControls.b4xdialog parent,RemoteObject __ref,RemoteObject _content,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
...
_p.setObject(__ref.getField(false,"_background" /*RemoteObject*/ ).getObject());Debug.locals.put("p", _p);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_createbutton" /*RemoteObject*/ ,(Object)(_cancel),(Object)(_btype));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_createbutton" /*RemoteObject*/ ,(Object)(_no),(Object)(_btype));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_createbutton" /*RemoteObject*/ ,(Object)(_yes),(Object)(_btype));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_internalsettextorcsbuildertolabel" /*RemoteObject*/ ,(Object)(_xlbl),(Object)(__ref.getField(false,"_title" /*RemoteObject*/ )));
...
this.state = 51;
_v = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
group73 = __ref.getField(false,"_background" /*RemoteObject*/ ).runMethod(false,"GetAllViewsRecursive");
index73 = 0;
...
this.state = 50;
_v.setObject(group73.runMethod(false,"Get",index73));}
if (true) break;
...
this.state = 54;
_v.setObject(group77.runMethod(false,"Get",index77));}
if (true) break;
...
try {
		Debug.PushSubsStack("ShowTemplate (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,59);
...
public ResumableSub_ShowTemplate(b4a.MyXUIControls.b4xdialog parent,RemoteObject __ref,RemoteObject _dialogtemplate,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xdialog", "showtemplate"), __ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_showcustom" /*RemoteObject*/ ,(Object)(_content),(Object)(_yes),(Object)(_no),(Object)(_cancel)));
this.state = 1;
return;
case 1:
//C
...
try {
		Debug.PushSubsStack("Stub_Click (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,361);
...
try {
		Debug.PushSubsStack("UpdateBlur (b4xdialog) ","b4xdialog",9,__ref.getField(false, "ba"),__ref,265);
...
Debug.JustUpdateDeviceLine();
_blurred = __ref.runClassMethod (b4a.MyXUIControls.b4xdialog.class, "_blur" /*RemoteObject*/ ,(Object)(_source));Debug.locals.put("blurred", _blurred);Debug.locals.put("blurred", _blurred);
